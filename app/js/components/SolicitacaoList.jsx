...
import { cristalSecondaryColor, grayDisabledColor } from './Theme';
import {
  listButtonStyle,
  tableRowStyle,
  updateToolbarStyle,
...
class SolicitacaoList extends React.Component {
    ...
    openDetails = (codSoco) => {
        ...
        redirectDetalhes(router, codSoco);
    }
    ...
    render() {
        ...
        const filterOrderPipeline = [
            ...
            (array) => {
                ...
                if (listOrderColumn === 'NOME_SOLICITANTE') {
                    return array.sort(
                        (a, b) => (a.NOME_SOLICITANTE.localeCompare(b.NOME_SOLICITANTE)
                    ));
                }
        ...
        finalList = finalList.slice((this.state.pageSize * (listPageNo - 1)),
            ...
            (<TableRow key={solicitacao.COD_SOCO}>
                ...
                <TableRowColumn style={tableRowStyleIcon}>
                    <FlatButton
                      ...
                      target="_blank"
                      secondary
                      icon={<ListIcon color={cristalSecondaryColor} />}
        ...
        const pageSelectionPages = realPageList.map(
          page =>
              (<BottomNavigationItem
                key={page}
                label={page}
                onTouchTap={() => { this.switchPage(page); }}
                icon={<CopyIcon color={cristalSecondaryColor} />}
                style={listButtonStyle}
              />)
        ...
        const pageSelectionList = (
            <Paper zDepth={1} style={bottomNavStyle}>
                <BottomNavigation selectedIndex={(realPageList.indexOf(listPageNo) + 2)}>
                    <BottomNavigationItem
                      label="Inicio"
                      icon={<FirstPageIcon color={cristalSecondaryColor} />}
                      onTouchTap={() => { this.switchPage(1); }}
                      style={listButtonStyle}
                    />
                    <BottomNavigationItem
                      label="Voltar"
                      icon={<BackPageIcon color={cristalSecondaryColor} />}
                    ...
                    <BottomNavigationItem
                      label="Prox"
                      icon={<NextPageIcon color={cristalSecondaryColor} />}
                      onTouchTap={() => { this.switchPage(nextPage); }}
                      style={listButtonStyle}
                    />
                    <BottomNavigationItem
                      label="Fim"
                      icon={<LastPageIcon color={cristalSecondaryColor} />}
                ...
                <Toolbar style={searchToolbarStyle}>
                        ...
                        <DeviceOrientation>
                            <Orientation orientation="portrait" alwaysRender>
                                <RaisedButton
                                  ...
                                  icon={<CachedIcon color={cristalSecondaryColor} />}
                    ...
                    <ToolbarGroup>
                        ...
                        <RaisedButton
                          ...
                          icon={<SearchIcon color={cristalSecondaryColor} />}
